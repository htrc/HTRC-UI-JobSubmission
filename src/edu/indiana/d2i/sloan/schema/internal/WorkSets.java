 ...
 *       &lt;sequence>
 *         &lt;element name="workset" type="{http://www.globus.org/namespaces/2004/10/gram/job/description}TransferRequestType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class WorkSets {
    ...
    protected List<TransferRequestType> workset;
     ...
     * 
     */
    public List<TransferRequestType> getWorkset() {
        if (workset == null) {
            workset = new ArrayList<TransferRequestType>();
        }
        return this.workset;
    }
